...
public class SPLConfig implements Listener{
	...
	public SPLConfig(SPL instance) {
		...
		String demitter = ",";
		String Spawnloc1 = config.getString("Spawn.Loc1");
		...
		String Spawnloc2 = config.getString("Spawn.Loc2");
		...
		String Despawnloc1 = config.getString("Despawn.Loc1");
		...
		String Despawnloc2 = config.getString("Despawn.Loc2");
		...
		plugin.SPL_Bg.put("Loc1", (config.getVector("BG.Loc1")));
		plugin.SPL_Bg.put("Loc2", (config.getVector("BG.Loc2")));
		
		plugin.SPL_SpawnRoom.put("SpawnRoom1loc1", (config.getVector("SpawnRoom1.Loc1")));
		plugin.SPL_SpawnRoom.put("SpawnRoom1loc2", (config.getVector("SpawnRoom1.Loc2")));
		plugin.SPL_SpawnRoom.put("SpawnRoom2loc1", (config.getVector("SpawnRoom2.Loc1")));
		plugin.SPL_SpawnRoom.put("SpawnRoom2loc2", (config.getVector("SpawnRoom2.Loc2")));
		
		plugin.SPL_Arena.put("1", (config.getVector("Arena.Loc1")));
		plugin.SPL_Arena.put("2", (config.getVector("Arena.Loc2")));
		
		String Gate1loc1 = config.getString("Gate1.Loc1");
		...
		String Gate1loc2 = config.getString("Gate1.Loc2");
		...
		String Gate2loc1 = config.getString("Gate2.Loc1");
		...
		String Gate2Loc2 = config.getString("Gate2.Loc2");
